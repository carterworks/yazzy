...
export default {
	...
	theme: {
		...
		colors: {
			 ...
			 * CSS custom properties. Make sure to use these with a fallback for non-Arc
			 * browsers (class="bg-arc-background-simple-color bg-yellow-50")
			 */
			arc: {
				"background-simple-color": "var(--arc-background-simple-color)",
				maxContrastColor: "var(--arc-palette-maxContrastColor)",
				...
				minContrastColor: "var(--arc-palette-minContrastColor)",
				title: "var(--arc-palette-title)",
				cutoutColor: "var(--arc-palette-cutoutColor)",
